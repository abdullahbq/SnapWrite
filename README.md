...
Build blog/documentation/tutorial website by markdown files in a Snap.

This project is open sourse and inspired from [Casual Markdown Blog] https://github.com/casualwriter/casual-markdown-blog

### I have added some new features:

* tutorials page (cofigure tutorials.md file in root folder)
* docs page (cofigure markdown files in docs folder and docs.md)
* blog page (cofigure markdown files in posts folder and index.md)
...
### Usage Guide from [Casual Markdown Blog] https://github.com/casualwriter/casual-markdown-blog

simply copy [index.html](https://github.com/abdullahbq/SnapWrite/blob/main/index.html) to web server, or fork this repo [SnapWrite](https://github.com/abdullahbq/SnapWrite). 

Or, clone this repo and if you are using VS Code use Live Preview extension by Microsoft to start the server while opening index.html....website will start in integrated browser. You can also open it in any other browser.
