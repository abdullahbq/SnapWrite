...
;(function(){ 
    ...
    md.toc = function (srcDiv, tocDiv, options ) {
      ...
      var html = '<div class="toc"><ul class="p-0">' + (tocTitle=='none'? '' : '<nav><p>' + tocTitle + '</p></nav>');
      ...
      for (var i=0; i<toc.length; i++ ) {
        ...
        html += '<li style="cursor: pointer;" class="' + toc[i].nodeName + '" title="#' + toc[i].id + '" onclick="location=this.title">' 
